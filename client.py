...
def run_all_endpoints(batch_size: int, num_trials: int = 5) -> dict:
    """
    ...
    """
    local_cpu_times = run_trials(batch_size=batch_size, local=True, num_trials=num_trials)
    remote_cpu_times = run_trials(batch_size=batch_size, local=False, remote_type='cpu', num_trials=num_trials)
    remote_gpu_times = run_trials(batch_size=batch_size, local=False, remote_type='gpu', num_trials=num_trials)
    ...
    for model_type in model_types:
        ...
        for onnx_quant in onnx_opts:
            ...
            for batch_size in batch_sizes:
                ...
                times = run_all_endpoints(batch_size, num_trials)
